...
class AppConfig {
  ...
  static String _dartDefineValue(String key) {
    return switch (key) {
      ...
      'ADMOB_ANDROID_APP_ID' => const String.fromEnvironment('ADMOB_ANDROID_APP_ID'),
      'ADMOB_IOS_APP_ID' => const String.fromEnvironment('ADMOB_IOS_APP_ID'),
      'ADMOB_REWARDED_ANDROID_UNIT_ID' => const String.fromEnvironment('ADMOB_REWARDED_ANDROID_UNIT_ID'),
      'ADMOB_REWARDED_IOS_UNIT_ID' => const String.fromEnvironment('ADMOB_REWARDED_IOS_UNIT_ID'),
      'ADMOB_NATIVE_ANDROID_UNIT_ID' => const String.fromEnvironment('ADMOB_NATIVE_ANDROID_UNIT_ID'),
      'ADMOB_NATIVE_IOS_UNIT_ID' => const String.fromEnvironment('ADMOB_NATIVE_IOS_UNIT_ID'),
      'ADMOB_INTERSTITIAL_ANDROID_UNIT_ID' => const String.fromEnvironment('ADMOB_INTERSTITIAL_ANDROID_UNIT_ID'),
      'ADMOB_INTERSTITIAL_IOS_UNIT_ID' => const String.fromEnvironment('ADMOB_INTERSTITIAL_IOS_UNIT_ID'),
      'IAP_PREMIUM_MONTHLY_ID' => const String.fromEnvironment('IAP_PREMIUM_MONTHLY_ID'),
      'IAP_PREMIUM_YEARLY_ID' => const String.fromEnvironment('IAP_PREMIUM_YEARLY_ID'),
      'IAP_SEASON_PASS_ID' => const String.fromEnvironment('IAP_SEASON_PASS_ID'),
      'IAP_PREMIUM_BUNDLE_ID' => const String.fromEnvironment('IAP_PREMIUM_BUNDLE_ID'),
      'KAKAO_MAP_KEY' => const String.fromEnvironment('KAKAO_MAP_KEY'),
      'GOOGLE_MAPS_API_KEY' => const String.fromEnvironment('GOOGLE_MAPS_API_KEY'),
      _ => '',
    };
  }
  ...
  bool get hasNativeAds => nativeAndroidUnitId.isNotEmpty || nativeIosUnitId.isNotEmpty;
